...
;hljs.registerLanguage("css",e)})();/*! `elixir` grammar compiled for Highlight.js 11.9.0 */
...
})();hljs.registerLanguage("elixir",e)})();/*! `ini` grammar compiled for Highlight.js 11.9.0 */
...
contains:[g,m,b]}]}}})();hljs.registerLanguage("python",e)})();/*! `scheme` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
const t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n="(-|\\+)?\\d+([./]\\d+)?",r={
$pattern:t,
