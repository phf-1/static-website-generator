...
from lib.message.article import Article
from lib.message.bg import BG
from lib.message.clone import Clone
from lib.message.copy import Copy
from lib.message.css import CSS
from lib.message.data import Data
from lib.message.description import Description
from lib.message.duplicated_uuids import DuplicatedUUIDs
from lib.message.exists import Exists
from lib.message.file import File
from lib.message.help import Help
from lib.message.html import HTML
from lib.message.id import Id
from lib.message.index import Index
from lib.message.lang import Lang
...
from lib.message.replaced import Replaced
